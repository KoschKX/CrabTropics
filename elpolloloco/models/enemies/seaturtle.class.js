class SeaTurtle extends Enemy{
	...
	hostile = false; stomp; bounceoninjured = true; attacksEnemies = true;

	state = -1; sttInterval; retreatTimer;
	...
	destroy(){
		super.destroy();
		this.world.clearRepeater(this.sttInterval); this.world.clearTimer(this.retreatTimer);
	...
	isHit(){
		super.isHit(); 
		if(!this.dead && this.health > 0) { this.currImage=0; this.world.audio.playSound('seaturtle_hitA', 1.0); }
	...
	retreat(){
		...
		let self = this; this.retreatTimer = this.world.setTimer(function(){
			self.state = 4; 
			self.currImage = 0; 
	...
	die(){
		...
		this.world.clearTimer(this.retreatTimer); this.world.clearTimer(this.reviveTimer);
