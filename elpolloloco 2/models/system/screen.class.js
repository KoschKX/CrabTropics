...
class Screen {
    ...
    resizeCanvas() {
        ...
        if(game.classList.contains('detached')){
            cvsH -= document.querySelector('#bottom').offsetHeight;
        }
        ...
        let uiW = document.querySelector('#canvas').offsetWidth;
        let uiH = document.querySelector('#canvas').offsetHeight;

        document.documentElement.style.setProperty('--ui-width', uiW + 'px');
        document.documentElement.style.setProperty('--ui-height', uiH + 'px');
    }
