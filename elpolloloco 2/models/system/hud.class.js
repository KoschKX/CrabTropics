...
class HUD {
    ...
    displayHealth() {
        ...
        let font = 'bold '+(wpct*2)+' Arial';
        drawText(this.ctx, wpct*(0.25), wpct*(0.5), 0, 0, text, 'red', font, 'left', 'middle', 'white', 1);
    }
    ...
    displayWealth() {
        ...
        let font = 'bold '+(wpct*2)+' Arial';
        drawText(this.ctx, wpct*(0.25), wpct*(1.1), 0, 0, text, 'white', font, 'left', 'middle', '', 1);
    }
    ...
    displayClock() {
        ...
        let font = 'bold '+(wpct*2.5)+' Arial';
        drawText(this.ctx, (this.cvs.width) * 0.5, wpct*(1.25), 0, 0, text, 'red', font, 'center', 'middle', 'white', 1);
    }
