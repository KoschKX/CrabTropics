	...
	playIntro(){
		...
		if(this.scale > 0.75 && !this.splashes){
			if(this.splashType == 1){
				...
				this.splashes = new Movie(this.world, './img/waves/SPLASH_001.webm', 4, 0, 0, 0, 1088, 900, 30, true);
				this.world.level.createVideo(this.splashes, './img/waves/SPLASH_001.webm', !check, false, false);
				this.splashes.pause(true);
			}else {
				this.splashes  = new Movie(this.world, './img/waves/SPLASH_001.png', 4, 40, 0, 0, 1088, 900);
			}
